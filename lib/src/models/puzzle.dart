...
class Puzzle extends Equatable {
  ...
  Puzzle move(Tile tile) {
    ...
    return Puzzle._(tiles: copy, emptyPosition: tile.position);
  }
  ...
  factory Puzzle.create(int crossAxisCount) {
    ...
    return Puzzle._(tiles: tiles, emptyPosition: emptyPosition);
  }
    ...
    if (_isSolvable(values)) {
      ...
      for (int i = 0; i < values.length; i++) {
        ...
        if (value == 0) {
          ...
          copy[value - 1] = copy[value - 1].move(position);
        }
      ...
      return Puzzle._(tiles: copy, emptyPosition: emptyPosition);
    } else {
      return shuffle();
    }
  }
